...
class ManagersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create manager" do
    assert_difference("Manager.count") do
      post managers_url, params: { manager: { address: @manager.address, name: @manager.name, phone_no: @manager.phone_no } }
    end
  ...
  test "should update manager" do
    patch manager_url(@manager), params: { manager: { address: @manager.address, name: @manager.name, phone_no: @manager.phone_no } }
